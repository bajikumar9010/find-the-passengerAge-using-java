...
public class Age {
    public static void main(String[] args) {
        int[] ageGroups = new int[10]; // to store count of passengers in each age group

        // sample data
        Integer [] passengerAges = {23, 45, 12, 36, 17, 8, 54, 31, 28, 41, 60,25,23,35,40,60,62,75};
        ArrayList<Integer> ages=new ArrayList<>(Arrays.asList(passengerAges));
